        ...
        switch (videoQuality) {
            case VIDEO_QUALITY_480P:
                if (CamcorderProfile.hasProfile(mCameraId, CamcorderProfile.QUALITY_480P)) {
                    ...
                    return getCamcorderProfile(VIDEO_QUALITY_LOWEST);
                }
                break;
            ...
            case VIDEO_QUALITY_720P:
                if (CamcorderProfile.hasProfile(mCameraId, CamcorderProfile.QUALITY_720P)) {
                    ...
                    return getCamcorderProfile(VIDEO_QUALITY_480P);
                }
                break;
            ...
            case CameraKit.Constants.VIDEO_QUALITY_1080P:
                if (CamcorderProfile.hasProfile(mCameraId, CamcorderProfile.QUALITY_1080P)) {
                    ...
                    return getCamcorderProfile(VIDEO_QUALITY_720P);
                }
                break;
            ...
            case CameraKit.Constants.VIDEO_QUALITY_2160P:
                try {
                    ...
                    return getCamcorderProfile(VIDEO_QUALITY_HIGHEST);
                }
                break;
