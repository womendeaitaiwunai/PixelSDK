...
import com.pixelall.pixellib.R;
...
import static com.pixelall.pixellib.camera.CameraKit.Constants.FACING_BACK;
import static com.pixelall.pixellib.camera.CameraKit.Constants.FACING_FRONT;
...
import static com.pixelall.pixellib.camera.CameraKit.Constants.FOCUS_TAP_WITH_MARKER;
...
public class CameraView extends FrameLayout {
    ...
    public CameraView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        focusMarkerLayout.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_UP && mFocus == FOCUS_TAP_WITH_MARKER) {
    ...
    public void setFocus(@Focus int focus) {
        this.mFocus = focus;
        if (this.mFocus == FOCUS_TAP_WITH_MARKER) {
            mCameraImpl.setFocus(FOCUS_TAP);
            return;
        }
